...
func Get[I, O any](f func(I) (O, error)) Converter[I, O] { return f }
...
func (c Converter[I, O]) Then(next Converter[O, O]) Converter[I, O] {
	return func(i I) (ret O, err error) {
		ret, err = c(i)
		if err != nil {
			return
		}
...
func (c Converter[I, O]) By(i I) Data[O] {
	return func() (ret O, err error) { return c(i) }
}
...
func Join[A, B, C any](i Converter[A, B], j Converter[B, C]) Converter[A, C] {
	return func(a A) (ret C, err error) {
		b, err := i(a)
		if err != nil {
			return
		}
